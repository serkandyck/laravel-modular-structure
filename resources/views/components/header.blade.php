            ...
            <div class="col-lg-7 order-lg-1">
                ...
                <div class="media d-block d-sm-flex align-items-sm-center">
                    <div class="u-lg-avatar position-relative mb-3 mb-sm-0 mr-3">
                        ...
                        @else
                            <span class="btn btn-lg btn-light btn-icon text-muted gradient-half-primary-v2">
                    ...
                    <div class="media-body">
                        ...
                        <span class="d-block text-white font-weight-medium">{{ Auth::user()->apps[0]->name }} <small>{{ Auth::user()->apps[0]->version }}</small></span>
                        <span class="d-block text-white small">{{ Auth::user()->apps[0]->package_name }}</span>
                        <div class="mt-1">
                            <a class="link-white small" href="{{ route('settings.edit') }}">Edit App Settings</a>
                        </div>
                    ...
                    <nav class="js-breadcrumb-menu navbar navbar-expand-lg u-header__navbar u-header__navbar--no-space">
                        <div id="breadcrumbNavBar" class="collapse navbar-collapse u-header__navbar-collapse">
                            <ul class="navbar-nav u-header__navbar-nav">
                                ...
                                <li class="nav-item u-header__nav-item">
                                    <a class="nav-link u-header__nav-link {{ Route::currentRouteNamed('payments.*') ? 'active' : '' }}" href="#">
                                        Inventory
                                    </a>
                                </li>
                                ...
                                <li class="nav-item u-header__nav-item">
                                    <a class="nav-link u-header__nav-link {{ Route::currentRouteNamed('forms.*') ? 'active' : '' }}" href="#">
                                        App Settings
                                    </a>
                                </li>
                            </ul>
