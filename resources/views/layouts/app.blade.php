    ...
    <div class="u-header__section">
        <div id="logoAndNav" class="container">
            ...
            <nav class="js-mega-menu navbar navbar-expand-md u-header__navbar u-header__navbar--no-space">
                <!-- Logo -->
                <a class="navbar-brand u-header__navbar-brand u-header__navbar-brand-center" href="{{ route('dashboard') }}" aria-label="PayMe">
                ...
                <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                    <ul class="navbar-nav u-header__navbar-nav">
                        ...
                        <li class="nav-item dropdown open" style="padding-left: 15px;">
                            ...
                            @else
                                <span class="btn btn-sm btn-primary btn-icon text-light gradient-half-primary-v2 rounded-circle">
                                <span class="btn-icon__inner">{{ substr(Auth::user()->name, 0, 1) }}</span>
                                </span>
                            @endif
                            <span class="text-muted">{{ Auth::user()->name }}</span>
                            </a>
                            <div style="right: 0; left: auto!important;" class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
